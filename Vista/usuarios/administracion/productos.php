    ...
    <div class="tablaProductos">
        <!-- Headers (visibles en escritorio, ocultos en móviles) -->
        <div class="header">Foto</div>
        <div class="header">Producto</div>
        <div class="header negocio-header">Negocio</div> <!-- Oculto solo en móvil -->
        <div class="header precio-header">Precio</div> <!-- Oculto solo en móvil -->
        ...
        <!-- Estos campos se ocultan en móvil -->
        <div class="campo negocio-campo"><?php echo htmlspecialchars($producto['nombre_negocio']); ?></div>
        <div class="campo precio-campo"><?php echo htmlspecialchars(number_format($producto['precio'], 2)); ?> COP</div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="foto_producto"
                                    name="foto_producto">
                                <small class="form-text text-muted">Deja este campo vacío si no quieres
                                    cambiar la foto.</small>
                                <?php if (!empty($producto['foto_producto'])): ?>
                                <div class="mt-2">
                                    <img src="../../../uploads/productos/<?php echo htmlspecialchars($producto['foto_producto']); ?>"
                                        alt="Producto actual" style="max-width: 100px; max-height: 100px;">
                                    <p>Foto actual</p>
                                </div>
                                <?php endif; ?>
                            </div>
