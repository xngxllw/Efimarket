...
<body>
    ...
    <header>
        <h1>Encuentra productos de despensa en el sector</h1>
    </header>
    <div class="contenedor-negocios">
        <?php
        require_once '../../Controlador/controladorNegocios.php';
        $controladorNegocios = new ControladorNegocios();
        $negocios = $controladorNegocios->obtenerNegociosPorCategoria(1); // Cambia el número según la categoría correcta para panaderías
