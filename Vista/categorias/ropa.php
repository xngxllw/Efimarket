...
<body>
    ...
    <header>
        <h1>Tiendas de Ropa y Accesorios</h1>
    </header>
    <div class="contenedor-negocios">
        <?php
        require_once '../../Controlador/controladorNegocios.php';
        $controladorNegocios = new ControladorNegocios();
        $negocios = $controladorNegocios->obtenerNegociosPorCategoria(8); // Cambia el número según la categoría correcta para panaderías
