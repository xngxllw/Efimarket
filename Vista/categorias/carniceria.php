...
<head>
    ...
    <title>Efimarket: Carnicerías y Derivadas</title>
...
<body>
    ...
    <header>
        <h1>Encuentra carnicerías en el sector</h1>
    </header>
    <div class="contenedor-negocios">
        <?php
        require_once '../../Controlador/controladorNegocios.php';
        $controladorNegocios = new ControladorNegocios();
    $negocios = $controladorNegocios->obtenerNegociosPorCategoria(6); // Cambia el número según la categoría correcta
