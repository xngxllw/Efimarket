...
<head>
    ...
    <title>Efimarket: Comidas Rápidas</title>
...
<body>
    ...
    <header>
        <h1>Encuentra negocios de comidas rápidas</h1>
    </header>
    <div class="contenedor-negocios">
        <?php
        require_once '../../Controlador/controladorNegocios.php';
        $controladorNegocios = new ControladorNegocios();
        $negocios = $controladorNegocios->obtenerNegociosPorCategoria(3); // Cambia el número según la categoría correcta para panaderías
