...
<head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdMhWjoJMe-J1QWIZW_37reKryLe-_sLc&callback=initMap"></script>
...
<body>
    ...
    <div class="hamburger-dropdown-menu hide" id="hamburgerDropdownMenu">
        ...
        <ul class="lista-menu">
            ...
            <li class="elementos-menu"><a href="../Vista/planes.php">Planes</a></li>
        </ul>
    </div>
    <div id="overlay"></div>
