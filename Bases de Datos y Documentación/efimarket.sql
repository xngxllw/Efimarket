...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2024 a las 00:13:40
...
(6, 'angelrestrepo0517@gmail.com', 'a', '2024-10-01 19:56:51');
...
(12, 1, 'Milagrito Café', 'Carrito de Café', 'CLL 32C #27A43', '3022397164', 'instagram.com/milagritocafemovil', 2, '4:00PM a 8:00PM', 'milagrito.jpeg'),
...
(29, 17, 'a', 'a', 'a', 'aq', 'aa', 7, 'a', 'cocinaIntegral.jpg');
...
INSERT INTO `postulaciones` (`id_postulacion`, `id_usuario`, `id_negocio`, `nombres`, `apellidos`, `edad`, `tipo_documento`, `documento_identidad`, `celular`, `correo_electronico`, `acepta_terminos`) VALUES
(4, 1, 12, 'Angel', 'Restrepo', 17, 't.i', '1036451368', '3196516362', 'angelrestrepo0517@gmail.com', 1);
...
(12, 12, 'Malteada de Café', 'frappe.jpg', 1, 6900),
...
(47, 12, 'Malteada de Chocolate', 'frappe.jpg', 0, 0);
...
INSERT INTO `reseñas` (`id`, `id_negocio`, `calificacion`, `comentario`, `fecha`, `id_usuario`) VALUES
(1, 12, 5, 'Excelente', '2024-09-17 12:59:06', NULL),
(2, 12, 5, 'Excelente', '2024-09-17 12:59:13', NULL),
(3, 12, 5, 'Excelente', '2024-09-17 13:00:10', NULL),
(4, 12, 5, 'Excelente', '2024-09-17 13:05:34', NULL),
(5, 12, 5, 'Muy bueno todo', '2024-09-17 13:06:10', NULL),
(6, 12, 5, 'Hola', '2024-09-17 13:06:53', NULL),
(7, 12, 5, 'hola', '2024-09-17 13:07:06', NULL),
(8, 9, 4, 'chimba de pan', '2024-09-17 13:07:28', NULL),
(9, 8, 5, 'muy buenos agridulces', '2024-09-28 11:21:41', 1),
(10, 22, 5, 'Muy buena fruta', '2024-09-28 11:24:42', 1),
(11, 8, 1, 'aa', '2024-10-02 02:42:50', 17),
(12, 8, 1, 'aa', '2024-10-02 02:44:28', 17),
(13, 12, 1, '222', '2024-10-02 02:47:12', 17),
(14, 8, 1, 'aaaa', '2024-10-02 02:48:26', 17);
...
(1, 'Angel Restrepo', 'miguelrpo05@gmail.com', '1036451368', 'admin', 3, 4501),
...
(17, 'AA', 'testAdmin@test.com', '123', 'admin', 1, 30);
...
--
ALTER TABLE `negocios`
  MODIFY `id_negocio` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `postulaciones`
--
ALTER TABLE `postulaciones`
  MODIFY `id_postulacion` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `vacantes`
  MODIFY `id_vacante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
